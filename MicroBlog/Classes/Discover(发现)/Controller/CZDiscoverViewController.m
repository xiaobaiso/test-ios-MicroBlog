...
- (void)viewDidLoad {
    [super viewDidLoad];
    CGRect bounds = CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width,  35);
    
    CZSearchBar *searchBar = [[CZSearchBar alloc]initWithFrame:bounds];
    searchBar.placeholder = @"facker";
